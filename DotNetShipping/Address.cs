...
namespace DotNetShipping
{
    ...
    {
        public Address(string city, string state, string postalCode, string countryCode, bool res) : this(null, null, null, city, state, postalCode, countryCode, res)
        {
        }

		public Address(string line1, string line2, string line3, string city, string state, string postalCode, string countryCode, bool isResidential)
		{
			Line1 = line1;
            Line2 = line2;
            Line3 = line3;
