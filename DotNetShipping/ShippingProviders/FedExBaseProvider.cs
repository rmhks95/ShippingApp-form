...
namespace DotNetShipping.ShippingProviders
{
    public abstract class FedExBaseProvider : AbstractShippingProvider
    {
        ...
        protected bool _residental = false;
        ...
        protected FedExBaseProvider(string key, string password, string accountNumber, string meterNumber, bool useProduction)
        {
        ...
        protected void SetOrigin(RateRequest request)
        {
            ...
            request.RequestedShipment.Shipper.Address.StateOrProvinceCode = "KS";
        ...
        protected void SetPackageLineItems(RateRequest request)
        {
            ...
            foreach (var package in Shipment.Packages)
            {
                ...
                request.RequestedShipment.RequestedPackageLineItems[i].GroupNumber = "1";
